...
public class deposit extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PLEASE ENTER THE AMOUNT OF DEPOSITS");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(121, 121, 121)
                        .addComponent(txtDeposit, javax.swing.GroupLayout.PREFERRED_SIZE, 240, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(35, 35, 35)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(29, 29, 29)
                .addComponent(txtDeposit, javax.swing.GroupLayout.PREFERRED_SIZE, 45, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(95, 95, 95)
    ...
    private void btnDepositMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDepositMouseClicked
        String pay = txtDeposit.getText();
        int a = JOptionPane.showConfirmDialog(null,"Do you really want to Deposit " + pay, "Select",JOptionPane.YES_NO_OPTION);
        if(a==0){
            if(pay.isEmpty()){
        ...
        if (pay.isEmpty()) {
            ...
            if (dbconn != null) {
                try {
                    ...
                    if (rowsAffected > 0) {
                        JOptionPane.showMessageDialog(this, "Transaction was successfully. You deposit " + decreaseAmount, "Success", JOptionPane.INFORMATION_MESSAGE);
                    } else {
